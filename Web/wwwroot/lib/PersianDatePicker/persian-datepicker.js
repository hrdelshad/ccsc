    ...
    _createClass(Input, [{
        ...
        value: function observe() {
            ...
            $(that.elem).bind('keyup', function (e) {
                var $self = $(this);
                var trueKey = false;
                if (e.keyCode === 46 || e.keyCode === 8 || e.keyCode < 105 && e.keyCode > 96 || e.keyCode < 58 && e.keyCode > 47 || ctrlDown && (e.keyCode == vKey || $.inArray(e.keyCode, ctrlKey) > 0)) {
                    trueKey = true;
                }
                if (trueKey) {
        ...
        key: '_updateAltField',
            value: function _updateAltField(unix) {
                if (unix == undefined) {
                    $(this.model.options.altField).val('');
                }
                else {
