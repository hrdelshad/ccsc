...
namespace ccsc.Web.Controllers
{
    public class CourseLevelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseLevelId,Title")] CourseLevel courseLevel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseLevelId,Title")] CourseLevel courseLevel)
        {
