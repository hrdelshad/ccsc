...
namespace ccsc.DataLayer.Migrations
{
    ...
    [Migration("20210706144718_CustomerVideos")]
    partial class CustomerVideos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContractCourse", b =>
                {
                    ...
                    b.HasKey("ContractsContractId", "CoursesCourseId");
            ...
            modelBuilder.Entity("CustomerVideo", b =>
                {
                    ...
                    b.HasKey("CustomersCustomerId", "VideosVideoId");

                    b.HasIndex("VideosVideoId");

                    b.ToTable("CustomerVideo");
                });
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Common.Comment", b =>
                {
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Common.UseFulLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Courses.Faculty", b =>
                {
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Courses.Group", b =>
                {
            ...
            modelBuilder.Entity("ContractCourse", b =>
                {
                    ...
                    b.HasOne("ccsc.DataLayer.Entities.Courses.Course", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Common.UseFulLink", b =>
                {
                    b.HasOne("ccsc.DataLayer.Entities.Identity.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Courses.Group", b =>
                {
                    b.HasOne("ccsc.DataLayer.Entities.Courses.Faculty", "Faculty")
                        .WithMany("Groups")
