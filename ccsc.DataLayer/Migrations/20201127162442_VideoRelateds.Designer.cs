...
namespace ccsc.DataLayer.Migrations
{
    ...
    [Migration("20201127162442_VideoRelateds")]
    partial class VideoRelateds
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Tutorials.SubSystemVideo", b =>
                {
                    b.Property<int>("SubSystemVideoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("SubSystemVideoId");

                    b.HasIndex("SubSystemId");

                    b.HasIndex("VideoId");

                    b.ToTable("SubSystemVideos");
                });
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Tutorials.UserTypeVideo", b =>
                {
                    b.Property<int>("UserTypeVideoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("UserTypeVideoId");

                    b.HasIndex("UserTypeId");

                    b.HasIndex("VideoId");

                    b.ToTable("UserTypeVideos");
                });
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Tutorials.SubSystemVideo", b =>
                {
                    b.HasOne("ccsc.DataLayer.Entities.ChangeSets.SubSystem", "SubSystem")
                        .WithMany("SubSystemVideos")
                        .HasForeignKey("SubSystemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ccsc.DataLayer.Entities.Tutorials.Video", "Video")
                        .WithMany("VideoSubSystems")
                        .HasForeignKey("VideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Tutorials.UserTypeVideo", b =>
                {
                    b.HasOne("ccsc.DataLayer.Entities.Tutorials.UserType", "UserType")
                        .WithMany("UserTypeVideos")
                        .HasForeignKey("UserTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ccsc.DataLayer.Entities.Tutorials.Video", "Video")
                        .WithMany("VideoUserTypes")
                        .HasForeignKey("VideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Tutorials.UserType", b =>
                {
                    b.Navigation("UserTypeVideos");
                });

            modelBuilder.Entity("ccsc.DataLayer.Entities.Tutorials.Video", b =>
                {
                    b.Navigation("VideoSubSystems");

                    b.Navigation("VideoUserTypes");
                });
