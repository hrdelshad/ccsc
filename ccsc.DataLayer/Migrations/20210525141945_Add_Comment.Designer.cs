...
namespace ccsc.DataLayer.Migrations
{
    ...
    [Migration("20210525141945_Add_Comment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ccsc.DataLayer.Entities.Common.Comment", b =>
                {
                    b.HasOne("ccsc.DataLayer.Entities.Contacts.Contact", null)
                        .WithMany("Comments")
                    ...
                    b.HasOne("ccsc.DataLayer.Entities.Services.Duty", null)
                        .WithMany("Comments")
                        .HasForeignKey("DutyId");

                    b.HasOne("ccsc.DataLayer.Entities.Requests.Request", null)
                        .WithMany("Comments")
                        .HasForeignKey("RequestId");

                    b.HasOne("ccsc.DataLayer.Entities.Customers.Server", null)
                        .WithMany("Comments")
                        .HasForeignKey("ServerId");

                    b.HasOne("ccsc.DataLayer.Entities.Services.Service", null)
                        .WithMany("Comments")
